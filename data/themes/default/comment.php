...
{ foreach($commentdb as $key => $comment)
 { ?>
    <p class="art-title"><a href="<?php echo $comment['aurl']; ?>"><?php echo $comment['title'];?></a></p>
    <p class="lesscontent"><?php echo $comment['content'];?></p>
...
<?php } ?>
 ...
 <aside id="subcontent">
  <div class=rightbox>
   <h3>热评文章</h3>
   <ul>
<?php foreach($host10comments AS $data) { ?>
