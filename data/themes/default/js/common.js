...
function printcontent()
{
	...
	sprnstr = "<!--start printcontent-->";//开始打印标识
	eprnstr = "<!--end printcontent-->";//结束打印标识
	prnhtml = bdhtml.substr(bdhtml.indexOf(sprnstr) + 25);//25是开始打印标识的字符串长度
...
function movec()
{
  ...
  var oliw=oli[0].offsetWidth; //每次移动的宽度	 
	...
	var rqbd=$a("picslideno","ul")[0];
	var extime;

	<!--for(var i=1;i<oli.length;i++){ rqbd.innerHTML+="<li>"+i+"</li>"; }-->
	var rq=$a("picslideno","li");
